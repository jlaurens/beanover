...
%\begin{itemize}[<+->]
%\item 1 \arabic{beamerpauses}
%\item 2 \arabic{beamerpauses}\BeanovesResolve{SIF=slideinframe}
%\item 3 \arabic{beamerpauses}
%\end{itemize}
%\BeanovesResolve[show]{SIF}
%\end{frame}
%%
\begin{frame}{An Algorithm For Finding Primes Numbers.}{\insertframenumber/\insertslidenumber}
\begin{verse}
\ttfamily
\uncover<?(A.1)->{1 \arabic{beamerpauses}}
\uncover<?(A.2)->{2 \arabic{beamerpauses}\Beanoves*{A!SIF=slideinframe}}
\uncover<?(?!A.3)->{3 \arabic{beamerpauses}}
\end{verse}
\BeanovesDebugOn
\BeanovesLogGProp
\typein{FOOO}
  SIF=\BeanovesResolve[show]{A!SIF}
\typein{FOOO}
