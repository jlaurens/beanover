...
all the integer values automatically update
}
\end{minipage}
}%
\end{frame}
...
\begin{itemize}
\item
As soon as one leaves basic frame layouts to make presentations more attractive and efficient, then \myPkg{beanoves} named overlay sets can come into play.
\item
