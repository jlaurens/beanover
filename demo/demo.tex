...
\item
The \myPkg{beanoves} manual available from \url{https://github.com/jlaurens/beanoves/blob/main/source/beanoves.pdf} or the \TeX\ distribution contains more technical description.
\item
