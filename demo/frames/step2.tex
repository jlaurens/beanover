...
%\Sticky<?(Sticky1.range)>[anchor=south,yshift=1.5\baselineskip(current page.south)]{\bfseries\begin{minipage}{0.5\textwidth} We jumped directly to the last slide...\end{minipage}}
%%
%\Sticky<?(Sticky2.range)>[anchor=south,yshift=1.5\baselineskip](current page.south){\bfseries\begin{minipage}{0.5\textwidth} .. and the source code reads:\end{minipage}}
%%
...
%\end{minipage}
%}
%\Sticky<?(Sticky3.2:2)>[anchor=center](current page.center){%
%  \tikz[
%    overlay,
%    remember picture,
%    my/.style={
