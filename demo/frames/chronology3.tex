...
\end{tikzpicture}%
%%
\Sticky<?(Sticky1:6)>(current page.south){0.6\textwidth}[anchor=south,yshift=1\baselineskip]{\bfseries%
• We had 8 slides\visible<?(Sticky1.3)->{ for 7 texts}\visible<?(Sticky1.5)->{ and 5 images}%
}%
\Sticky<?(Sticky1.7:2)>(current page.south){0.6\textwidth}[anchor=south,yshift=1\baselineskip]{\bfseries%
• Blue dots for uncovered text%
}%
\Sticky<?(Sticky1.9:2)>(current page.south){0.6\textwidth}[anchor=south,yshift=1\baselineskip]{\bfseries%
• orange squares for uncovered images
}%
\Sticky<?(Sticky1.11:2)>(current page.south){0.75\textwidth}[anchor=south,yshift=1\baselineskip]{\bfseries%
• magenta squares for uncovered transparent images
}%
\Sticky<?(Sticky2.1)>(current page.south){0.3\textwidth}[anchor=south,yshift=1\baselineskip]{\bfseries%
Let us organize all this
}%
\Sticky<?(Sticky2.2:4)>(current page.south){0.75\textwidth}[anchor=south,yshift=1\baselineskip]{\bfseries%
• 3 slides for the Air, 4 for the Water, 1 to summarize
}%


\begin{textblock}{8}[1,0.5](16,8)
\begin{myCodeBox}%
\ttfamily\small
...
\vbox to 0pt{\hbox{%
  \tikz [
    ...
    \node [my code] at (current page.center) [text width=0.8\textwidth] {%
\backslash only <
...
\begin{textblock}{12.8}[1,0.5](16,8)
\begin{myCodeBox}%
\ttfamily\small
\setlength{\tabcolsep}{0mm}
\begin{tabular}{l}
